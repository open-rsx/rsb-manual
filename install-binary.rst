...
<https://ci.cor-lab.org/job/rsb-java-0.11/label=ubuntu_precise_64bit/lastSuccessfulBuild/artifact/rsb-java-protobuf2.4.1.zip>`_
...
#. Download the |main_binary| binary from the appropriate location:
   ...
   * `Linux i686 <https://ci.cor-lab.de/job/rsb-tools-cl-0.11/label=ubuntu_precise_32bit/>`_
   * `Linux x86_64 <https://ci.cor-lab.de/job/rsb-tools-cl-0.11/label=ubuntu_precise_64bit/>`_
   * `MacOS x86_64 <https://ci.cor-lab.de/job/rsb-tools-cl-0.11-macos/label=MAC_OS_mavericks_64bit/>`_
...
#. Download the artifact for your Visual Studio version
   ...
   https://ci.cor-lab.org/view/windows/job/rsx-0.11-windows-package/ (by
