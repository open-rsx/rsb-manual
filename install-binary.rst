...
<https://ci.cor-lab.org/view/rsx-0.17/job/rsb-java-0.17/label=ubuntu_trusty_64bit/lastSuccessfulBuild/artifact/.archive/rsb-java.zip>`_
...
#. Download the |main_binary| binary from the appropriate location:
   ...
   * `Linux i686 <https://ci.cor-lab.de/job/rsb-tools-cl-0.17/label=ubuntu_xenial_32bit/>`_
   * `Linux x86_64 <https://ci.cor-lab.de/job/rsb-tools-cl-0.17/label=ubuntu_xenial_64bit/>`_
   * `MacOS x86_64 <https://ci.cor-lab.de/job/rsb-tools-cl-0.17-macos/label=MAC_OS_mavericks_64bit/>`_
   * `Windows i686 <https://ci.cor-lab.de/job/rsb-tools-cl-0.17-wine/label=ubuntu_precise_32bit>`_
     (experimental)
...
#. Download the artifact for your Visual Studio version
   ...
   https://ci.cor-lab.org/job/rsx-0.17-windows-package/ (by
