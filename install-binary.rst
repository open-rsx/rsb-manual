...
<https://ci.cor-lab.org/view/rsx-trunk/job/rsb-java-0.13/label=ubuntu_trusty_64bit/lastSuccessfulBuild/artifact/.archive/rsb-java.zip>`_
   ...
   .. code-block:: xml
      ...
      <dependencies>
          <dependency>
              ...
              <version>[0.13,0.14-SNAPSHOT)</version>
          </dependency>
      </dependencies>
...
#. Download the |main_binary| binary from the appropriate location:
   ...
   * `Linux i686 <https://ci.cor-lab.de/job/rsb-tools-cl-0.13/label=ubuntu_trusty_32bit/>`_
   * `Linux x86_64 <https://ci.cor-lab.de/job/rsb-tools-cl-0.13/label=ubuntu_trusty_64bit/>`_
   * `MacOS x86_64 <https://ci.cor-lab.de/job/rsb-tools-cl-0.13-macos/label=MAC_OS_mavericks_64bit/>`_
...
#. Download the artifact for your Visual Studio version
   ...
   https://ci.cor-lab.org/job/rsx-0.13-windows-package/ (by
